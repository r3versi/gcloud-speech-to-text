...
class OperationsApi(object):
    ...
    def speech_operations_get(self, name, **kwargs):  # noqa: E501
        """speech_operations_get  # noqa: E501

        Gets the latest state of a long-running operation.  Clients can use this method to poll the operation result at intervals as recommended by the API service.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.speech_operations_get(name, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str name: The name of the operation resource. (required)
        ...
        if kwargs.get('async_req'):
            return self.speech_operations_get_with_http_info(name, **kwargs)  # noqa: E501
        else:
            (data) = self.speech_operations_get_with_http_info(name, **kwargs)  # noqa: E501
            return data

    def speech_operations_get_with_http_info(self, name, **kwargs):  # noqa: E501
        """speech_operations_get  # noqa: E501

        Gets the latest state of a long-running operation.  Clients can use this method to poll the operation result at intervals as recommended by the API service.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.speech_operations_get_with_http_info(name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['name', 'fields', 'upload_type', 'xgafv', 'param_callback', 'alt', 'upload_protocol', 'pretty_print', 'quota_user']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method speech_operations_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `speech_operations_get`")  # noqa: E501
