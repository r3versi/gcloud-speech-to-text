...
class LongRunningRecognizeResponse(object):
    ...
    def __init__(self, results=None):  # noqa: E501
        """LongRunningRecognizeResponse - a model defined in Swagger"""  # noqa: E501
        self._results = None
    ...
    @property
    def results(self):
        """Gets the results of this LongRunningRecognizeResponse.  # noqa: E501

        Sequential list of transcription results corresponding to sequential portions of audio.  # noqa: E501

        :return: The results of this LongRunningRecognizeResponse.  # noqa: E501
    ...
    def results(self, results):
        ...
        :param results: The results of this LongRunningRecognizeResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LongRunningRecognizeResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LongRunningRecognizeResponse):
            return False
